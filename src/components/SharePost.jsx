...
const SharePost = ({ title, slug, description }) => {
  ...
  const blog = encodeURIComponent("https://masonliebe.vercel.app/blog/");
  ...
  const options = [
    ...
    },
    {
      ...
      shareUrl: `https://api.whatsapp.com/send?text=${encodeURIComponent(
        "Read this amazing article by Mason Liebe"
      ...
      <div className="flex flex-wrap items-center gap-2 tracking-tight">
        {options.map((data, id) => (
          <a
            ...
            className="cursor-pointer w-12 h-12 p-2 grid place-content-center text-2xl border dark:border-zinc-800 border-zinc-200 rounded-md"
          >
