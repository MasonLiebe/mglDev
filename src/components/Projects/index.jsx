...
const Projects = ({ projects, catList }) => {
  ...
  return (
    <section id="work" className="container2 section text-white">
      <div className="flex items-center justify-between">
        ...
        <a
          ...
          className="flex px-8 items-center justify-center text-center gap-x-2 bg-[rgba(39,39,43,.4)] border border-transparent dark:hover:border-zinc-700 hover:border-zinc-200 rounded-md py-2 text-base font-incognito font-semibold"
        >
          View all
        </a>
      </div>
