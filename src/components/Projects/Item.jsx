  ...
  return (
    <Slide delay={0.3}>
      <motion.div
        ...
        className="portfolio__items card card-two min-h-[620px] pb-14 rounded-lg border border-zinc-800"
      >
        ...
        <span className="portfolio__category text-[#66d9ed]">
        ...
        <div className="flex flex-col justify-between">
          <p className="portfolio__description text-zinc-300">
          ...
          <a
            ...
            href={`/project/${project?.slug.current}`}
            className="flex items-center gap-2 group transition-all duration-200 ease-in text-[#66d9ed] absolute bottom-5"
          >
            See Details
