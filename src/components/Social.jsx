              ...
              <div key={social._id}>
                {social.name === "instagram" && social.link !== undefined ? (
                  <a
                    ...
                    className="shadow-[#66d9ed_0px_0px_3px] hover:text-[#66d9ed] cursor-pointer w-10 h-10 hover:scale-125 transition-all duration-200 ease-in rounded-full flex items-center justify-center"
                  >
