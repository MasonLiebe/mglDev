  ...
  return (
    ...
    <Disclosure as="div" className="mt-4 [&>*:last-child]:mb-2">
      {({ open }) => (
        <>
          <Disclosure.Button
            className={`flex w-full mt-10 justify-between rounded-md shadow-[#66d9ed_0px_0px_3px] px-6 py-5 text-left max-sm:text-sm font-medium text-white focus:outline-none ${
              open ? "bg-[#66d9ed5b]" : "bg-transparent"
            }`}
          >
            <div>
          ...
          >
            <Disclosure.Panel className="px-6 pt-5 mt-4 rounded-md max-sm:text-sm bg-[#4cacbd3a] pb-5 text-gray">
                ...
                <div className="flex-1">
                  ...
                  {education?.link !== undefined ? (
                    <div className="flex items-center gap-1">
                      ...
                      <a
                        href="#"
                        className="flex items-center gap-x-2 transition-all duration-150 ease-in hover:text-[#66d9ed]"
                      >
                        {education?.link}
                      </a>
                    </div>
