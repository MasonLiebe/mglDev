  ...
  return (
    <div className="fixed bottom-8 right-8">
      <a
        ...
        } bg-[#66d9ed98] w-10 h-10 hover:bg-[#66d9edb4] cursor-pointer inline-flex items-center justify-center rounded-full p-3 text-[#fff] shadow-sm transition-all duration-200 ease-in focus:outline-none`}
      >
