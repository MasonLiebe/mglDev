...
export const components = {
      ...
      return (
        <div>
          <a
            ...
            className="flex w-fit px-8 items-center justify-center text-center gap-x-2 bg-[rgba(39,39,43,.4)] border border-transparent dark:hover:border-zinc-700 hover:border-zinc-200 rounded-md py-2 text-base font-incognito font-semibold"
          >
            {props.value.name}
          </a>
        </div>
  ...
  block: {
    ...
    h2: ({ children }) => <h2 className="text-4xl text-white">{children}</h2>,
    h3: ({ children }) => <h3 className="text-2xl text-white">{children}</h3>,
    h4: ({ children }) => <h4 className="text-xl text-white">{children}</h4>,
